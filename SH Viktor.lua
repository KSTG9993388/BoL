...
if AUTOUPDATE then
   SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/KSTG9993388/BoL/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/KSTG9993388/BoL/"..SCRIPT_NAME..".version"):CheckUpdate()
end
